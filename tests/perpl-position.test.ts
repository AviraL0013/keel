...
import { assertPerplBookSetupReady } from '../server/src/infrastructure/perpl/runtime.js'
...
describe('Perpl position normalization', () => {
  ...
  it('rejects stale position telemetry before live Book creation', () => {
    ...
    expect(() => assertPerplBookSetupReady(position, telemetry, now)).toThrow('PERPL_TELEMETRY_STALE')
